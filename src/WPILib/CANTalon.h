 ...
 */
class CANTalon: public MotorSafety, public CANSpeedController, public ErrorBase,
...
public:
    ...
    virtual FeedbackDeviceStatus IsSensorPresent(FeedbackDevice feedbackDevice)
    const;
